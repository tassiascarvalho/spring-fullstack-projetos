...
public class ClienteControle {
    ...
    // inje‡Æo para cliente repositorio ser utilizado no clientevalidador
    @InitBinder("cliente")
    ...
    public String salvar(@Valid Cliente cliente, BindingResult resultado, RedirectAttributes attr,
        ...
        // Verifica se teve erros na valida‡Æo
    ...
    public String excluir(@PathVariable Long id, RedirectAttributes attrs) {
        try {
            ...
            attrs.addFlashAttribute("alert",
                    new AlertDTO("Cliente nÆo pode ser exlu¡do pois possui projetos associados a ele", "alert-danger"));
        }
