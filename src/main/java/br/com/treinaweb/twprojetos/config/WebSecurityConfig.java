...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter{
    ...
    //Se comentar todo esse c�digo desabilita a seguran�a da aplica��o.

    @Override
    protected void configure(HttpSecurity http) throws Exception {
        // Configura as rotas publicas e privadas da aplica��o
        http.authorizeRequests()
            ...
            //anyRequest qualquer requisi��o tem que estar autenticada
            .anyRequest().authenticated();

        http.formLogin()
            .loginPage("/login")
            .defaultSuccessUrl("/clientes")
            //Passando o parametro do username fazendo liga��o com a tela de login
            .usernameParameter("email")
            .permitAll();
        //Para aceitar requisi��o de logout via link que � GET
        http.logout()
        ...
        http.rememberMe()
            ...
            .key("chaverememverMe");//Em produ��o essa chave deve ser complexa pois vai para o cache
    }

    @Override
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        //Informa a implementa��o e o algortimo de hash para o login
